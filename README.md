...
As of version **v0.10.0**, tools are available as executables in `bin/`, and CLI options are strictly typed.
...
- **Pre-Release Scan**: `dart run bin/triage_cli.dart --pre-release --prev-tag v0.9.2 --version 0.10.0`
- **Post-Release Loop**: `dart run bin/triage_cli.dart --post-release --version 0.10.0 --release-tag v0.10.0`
