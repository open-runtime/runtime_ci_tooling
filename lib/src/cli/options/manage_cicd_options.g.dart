...
ArgParser _$populateManageCicdOptionsParser(ArgParser parser) => parser
  ...
  ..addFlag('output-github-actions', help: r'Write version outputs to $GITHUB_OUTPUT for GitHub Actions')
  ..addOption('artifacts-dir', help: 'Directory containing downloaded CI artifacts (create-release)')
  ..addOption('repo', help: 'GitHub repository slug owner/repo (create-release)')
  ..addOption('release-tag', help: 'Git tag for the release (post-release-triage)')
  ..addOption('release-url', help: 'URL of the GitHub release page (post-release-triage)')
  ..addOption('manifest', help: 'Path to issue_manifest.json (post-release-triage)');
