...
ArgParser _$populateArchiveRunOptionsParser(ArgParser parser) => parser
  ..addOption('run-dir', help: 'Directory containing the CI run to archive');

final _$parserForArchiveRunOptions = _$populateArchiveRunOptionsParser(
  ArgParser(),
);
