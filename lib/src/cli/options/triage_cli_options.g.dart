...
TriageCliOptions _$parseTriageCliOptionsResult(ArgResults result) => TriageCliOptions(
...
ArgParser _$populateTriageCliOptionsParser(ArgParser parser) => parser
  ...
  ..addFlag('pre-release', help: 'Pre-release mode (prepare changelog before release)')
  ..addFlag('post-release', help: 'Post-release mode (update after release is published)')
...
final _$parserForTriageCliOptions = _$populateTriageCliOptionsParser(ArgParser());
