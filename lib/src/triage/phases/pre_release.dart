...
Future<String> preReleaseTriage({
  ...
  if (totalIssues > 0) {
    print('  Running Gemini 3.1 Pro Preview to correlate $totalIssues issues with diff...');
...
/// Use Gemini 3.1 Pro Preview to assess confidence scores for issue-to-diff correlations.
